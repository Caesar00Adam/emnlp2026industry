...
class RLHFDataset(Dataset):
    ...
    def __init__(
        ...
        image_selection_key: str = "image_selection",
        ...
        self.image_selection_key = image_selection_key
    ...
    def __getitem__(self, index):
        ...
        original_prompt = example[self.prompt_key]
        messages = self._build_messages(example)
        ...
        if self.image_selection_key in example:
            example["image_selection"] = example.pop(self.image_selection_key)
        return example
